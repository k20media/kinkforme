...
namespace Drupal\store_dashboard\Form;
 ...
 */
class CustomDashboardMetricsForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if (!$store_id) {
        $form['message'] = [
            '#type' => 'markup',
            '#markup' => $this->t('You do not have a store associated with your account. Please <a href=":link">create a store</a> first.', [':link' => '/store/add/online']),
            '#prefix' => '<div class="my-custom-class">',
            '#suffix' => '</div>',
        ];
        return $form;
    }
    ...
    $active_store = $store_storage->load($store_id);
